...
export const demoEvents = [
  {
    ...
    event_time: '11:00 AM',
    description: 'Join us as we prepare and serve meals to our neighbors downtown. All are welcome — come to serve, come to eat, come to belong.',
    location: 'Downtown Community Center, Amarillo',
  ...
  },
  {
    ...
    event_time: '9:00 AM',
    description: 'Grab some gloves and a trash bag. We\'re beautifying our streets, one block at a time. Volunteers and families welcome.',
    location: 'Meeting at Citychurch HQ',
    registration_url: 'https://docs.google.com/forms',
    image_url: null,
    featured: false,
    active: true,
